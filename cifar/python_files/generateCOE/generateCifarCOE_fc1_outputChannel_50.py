...
output2 = model(inputs_buffer[0]*2**decimal)
print(output2)
...
#start writing COE
file = open("cifar10_fc1_outputChannel_50.coe","w")
file.write("memory_initialization_radix=2;\n")
file.write("memory_initialization_vector=00000000000000000000 \n") #for read mode
...
#FC1 output & FC2 input: starting address = 54914+51200 = 106114
#FC1 output has 1*1*50 = 50
for ii in range(50):
      for ir in range(1):
            for ic in range(1):
                  file.write("0000000000000000 ")
...
#FC2 weight: starting address = 106114+50 = 106164
#size = 1*1*50*10 = 500
...
#FC2 output: starting address = 106164+500 = 106664
